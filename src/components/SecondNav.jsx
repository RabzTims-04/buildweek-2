...
const SecondNav =()=>{
    ...
    return(
        ...
        <Form inline id="container">
            <InputGroup>
            <InputGroup.Prepend>
            <svg id='avatar'xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-person-circle" viewBox="0 0 16 16">
        ...
        <Form inline id="container1">
            ...
            <Button  className="btn btn-primary"type="submit"style={{borderRadius:"25px",marginLeft:'10px',marginRight:'10px'}} >Open to</Button>
        </Form>
