                 ...
                 <Container className="p-0">                  
                  <div className="d-flex newspostbtn justify-content-center">
                    <Button variant="" id='photo' className="d-block d-lg-flex flex-row pl-0 pt-0 pb-3">
                      ...
                      <Button variant="" id="event" className="d-block d-lg-flex flex-row pl-1 pt-0 pb-3">
                      ...
                      <Button variant="" id='article' className="d-block d-lg-flex flex-row pl-1 pt-0 pb-3">
