...
class NewsFeed extends Component {
  ...
  img = {
    imgcover: [
      'https://content.linkedin.com/content/dam/business/marketing-solutions/global/en_US/blog/2018/05/refresh.gif',
      ...
      'https://content.linkedin.com/content/dam/business/talent-solutions/global/en_us/blog/2013/09/hugh-grant.gif',
    ],
  };

  componentDidUpdate = (prevProps) => {
    if (prevProps.newPost !== this.props.newPost) this.newsFeedFetch();
  };
  ...
  render() {
    return this.state.newsFeeds ? (
      this.state.newsFeeds.map((news, i) => (
        <Card key={news._id} className='rounded mt-3'>
          <Container className='pt-3 pr-0 pl-3 pb-0 mb-0'>
            <div className='d-flex flex-row'>
              <Col xs={1} className='p-0 mt-1'>
                <img
              ...
              <Col xs={9} className='d-flex flex-column'>
                ...
                <span style={{ fontSize: '0.7em' }} className='text-muted'>
                  {news.user.title}
                </span>
                <div className='d-flex flex-row'>
                  <span style={{ fontSize: '0.7em' }} className='text-muted'>
                  ...
                  <svg
                    ...
                    fill='currentColor'
                    className='mercado-match m-0 p-0 ml-2'
                    width='12'
                    height='12'
                    focusable='false'
                  >
            ...
            <div
              ...
              className='d-flex flex-row mt-2 mb-0'
            >
              <p className='mb-0'>{news.text}</p>
            </div>
          </Container>
          ...
          <Container>
            <div className='d-flex flex-row comments-btn py-2'>
              ...
              <span
                ...
                className='text-muted ml-2 number-span'
              >
                {' '}
                <Link
                  style={{ fontSize: '1em', fontWeight: '450' }}
              ...
              <span style={{ fontSize: '0.7em' }} className='text-muted ml-2'>
                {' '}
                <Link
                  style={{ fontSize: '1em', fontWeight: '450' }}
                  className='text-muted'
