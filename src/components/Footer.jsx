    ...
    return(
        ...
        <div className="container margin">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-question-circle-fill" viewBox="0 0 16 16">
               ...
               <svg className='footerIcon2' xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-gear-fill mt-5" viewBox="0 0 16 16">
               ...
               <h6 className="">
                Questions?</h6>
                <div><p>Visit our Help Center</p></div>
                ...
                Manage your account and privacy</h6>
            ...
            <Dropdown className="language">
                ...
                <Dropdown.Menu className="options">
                    ...
                    <Dropdown.Item href="#/action-3">Nerderlands(Dutch)</Dropdown.Item>
