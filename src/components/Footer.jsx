    ...
    <div className='container margin'>
      ...
      <Row>
        ...
        <Col sm={4} md={3} className='footerIcon'>
          ...
          <div >
            <p className="visit">Visit our Help Center</p>
          </div>
          <button style={{backgroundColor:'#F3F2EF'}}>
          <h6 className='d-flex'>
          <svg
            className='footerIcon2 bi bi-gear-fill '
            xmlns='http://www.w3.org/2000/svg'
            width='16'
            height='16'
            fill='currentColor'
          ...
          <div>
          <p >Go to your Settings.</p></div>
          </button>
        </Col>
       
        <Col sm={4} md={2}className='last-col ml-5'>
          <p>Select Language</p>
          <Dropdown className='language mb-3'>
